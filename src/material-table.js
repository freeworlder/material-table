                            ...
                            {(provided, snapshot) => {
                                ...
                                return (
                                    <div ref={provided.innerRef}>
                                        <div ref={this.tableContainerDiv} style={{
                                            ...
                                            {this.state.width && props.options.fixedColumns && props.options.fixedColumns.right ?
                                                <div style={{
                                                    width: this.getColumnsWidth(props, -1 * props.options.fixedColumns.right),
                                                    position: 'absolute',
                                                    top: 0,
                                                    right: 0,
                                                    ...
                                                    <div style={{
                                                        ...
                                                        background: 'white',
                                                        transform: `translateX(calc(${this.getColumnsWidth(props, -1 * props.options.fixedColumns.right)} - 100%))`
                                                    }}>
                                                        {table}
                                                    </div>
                                                </div> : null
